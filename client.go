...
// APIClient manages communication with the PDX API API v1.0.0
...
type APIClient struct {
	...
	SecureMessagesAPI *SecureMessagesAPIService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.SecureMessagesAPI = (*SecureMessagesAPIService)(&c.common)
